...
import net.matthaynes.juicer.AppConfig.DefaultingLanguageDetector;
...
public class ArticleExtractorService {
  ...
  @Nonnull
  private final DefaultingLanguageDetector languageDetector;
  ...
  public ArticleExtractorService(@Nonnull NetworkHelper networkHelper, @Nonnull Goose goose,
      @Nonnull NamedEntityService namedEntityService, DefaultingLanguageDetector languageDetector) {
  ...
  public Article extract(@Nonnull String url) {
    ...
    String language = languageDetector.detect(html);
    com.gravity.goose.Article article = goose.extractContent(url, html, language);
    ...
    return new Article(article.canonicalLink(), article.domain(), article.linkhash(),
        article.title(), article.metaDescription(), article.cleanedArticleText(), image,
  ...
  public static class Article {
    ...
    public Article(String url, String domain, String hash, String title, String description,
        String body, Image image, Map<String, String> map, Collection<NamedEntity> entities) {
      this.url = url;
      this.domain = domain;
      this.hash = hash;
      this.title = title;
